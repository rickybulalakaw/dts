...
if(!isset($_GET['did'])){
        ...
        if($trackidpresent == 1){
            ...
            echo "<i>If this document needs to be routed to officials regardless of their office(s), click <a href='routetoindividualnew.php?did=$did&trackid=$trackid'>here</a></i>.";
        } else {

            echo "<i>If this document needs to be routed to officials regardless of their office(s), click <a href='routetoindividualnew.php?did=$did'>here</a></i>.";
