...
$getlatest20docs = "select id, subject, employeeid, datecreated, timestamp from document where originatingunit = '$officeid' and status = 'Open' order by timestamp";
...
if($res20 -> num_rows >= 1)
{
    ...
    echo "<p align='center'>Below are documents or instructions your office has opened:</p>";
